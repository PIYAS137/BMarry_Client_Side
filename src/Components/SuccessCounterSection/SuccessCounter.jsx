    ...
    <div>
      ...
      <div className=" p-10 flex flex-wrap space-x-5">
        ...
        <div className="p-5 rounded-lg flex-1 bg-yellow-400">
          <FcBusinessman className=" text-5xl md:absolute" />
        ...
        <div className="p-5 rounded-lg flex-1 bg-pink-200">
          <FcBusinesswoman className=" text-5xl md:absolute" />
        ...
        <div className="p-5 rounded-lg flex-1 bg-green-600 mt-5 md:mt-0">
