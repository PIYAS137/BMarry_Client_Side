      ...
      <div className=" flex justify-center ">
        <div className=" grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 items-center space-x-5 space-y-5">
          <div className=" bg-pink-500 max-w-sm rounded-xl p-5">
            ...
            <h1 className=" text-white text-5xl my-1 font-bold text-center">{allSummary.total_biodata_count}</h1>
          ...
          <div className=" bg-yellow-500 max-w-sm rounded-xl p-5">
            ...
            <h1 className=" text-black text-5xl my-1 font-bold text-center">{allSummary.male_biodata_count}</h1>
          ...
          <div className=" bg-pink-300 max-w-sm rounded-xl p-5">
            ...
            <h1 className=" text-black text-5xl my-1 font-bold text-center">{allSummary.female_biodata_count}</h1>
          ...
          <div className=" bg-blue-300 max-w-sm rounded-xl p-5">
            ...
            <h1 className=" text-black text-5xl my-1 font-bold text-center">{allSummary.premium_biodata_count}</h1>
          ...
          <div className=" bg-purple-400 max-w-sm rounded-xl p-5">
            ...
            <h1 className=" text-black text-5xl my-1 font-bold text-center">{allSummary.total_revenue}$</h1>
            <h1 className=" text-center text-black">Total Money</h1>
          </div>
        </div>
      </div>
      <div>
        <AdminStatistics finalData={allSummary} />
      </div>
    </div>
  )
}
